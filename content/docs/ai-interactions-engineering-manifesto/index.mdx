...
1. [Trustworthy AI in B2B Systems](docs/trustworthy-ai-in-b2b-systems)
2. [Expectations Engineering and UAT](docs/expectations-engineering-uat)
...
17. [Spry: Literate Programming with Executable Markdown](spry-literate-programming.md)
